...
class PesertadidikR extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pesertadidik.index')->with('success','peserta berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pesertadidik.index')->with('success','peserta berhasil dirubah');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pesertadidik.index')->with('success','peserta berhasil di hapus');
    }
